...
function parseAutoImportsDts(file) {
...
function autoImportGlobals() {
  const parsed = [
    ...parseAutoImportsDts(path.resolve(__dirname, 'auto-imports.d.ts')),
    ...parseAutoImportsDts(path.resolve(__dirname, 'components.d.ts'))
  ]
